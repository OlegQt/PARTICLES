...
HRESULT Engine::RenderTreeBorder(CQuadTree* pTree)
{
	if (pTree->IsSubDevided())
	{
		RenderTreeBorder(pTree->GetChild(0));
		RenderTreeBorder(pTree->GetChild(1));
		RenderTreeBorder(pTree->GetChild(2));
		RenderTreeBorder(pTree->GetChild(3));
	}
	else
	{
